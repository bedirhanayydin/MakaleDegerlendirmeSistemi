...
/**
 * Servlet implementation class YazarHome
 */
@WebServlet("/YazarHome")
public class YazarHomeServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public YazarHomeServlet() {
        super();
		...
		// TODO Auto-generated method stub
		 int YazID =-1;
	        ...
	        try(Connection connection = ConnectionUtils.getMyConnection(); 
	                PreparedStatement preparedStatement = connection.prepareStatement("SELECT * FROM makale WHERE YazID =?");){
	        ...
	        RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/Views/YazarHome.jsp");
			dispatcher.forward(request, response);
	}
