...
import Model.makale;
/**
 * Servlet implementation class Hakem_MakDownServlet
 */
@WebServlet("/Hakem_MakDown")
public class Hakem_MakDownServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Hakem_MakDownServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		 ...
		 Connection conn = null;
	       try {
	           ...
	           makale mk = getmkFromDB(conn, id, HID);
	 ...
	 private makale getmkFromDB(Connection conn, int id, int HID) throws SQLException {
		   
		   
		   
		   
		   
	       String sql = "Select * from makale inner join yazarlar on yazarlar.id = makale.YazID inner join makalehakem on makale.ID = makalehakem.makid Where hakid =? AND makale.ID = ?";
