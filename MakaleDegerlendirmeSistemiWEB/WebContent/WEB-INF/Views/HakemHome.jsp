...
for(Cookie cookie : cookies){
	switch(cookie.getName())
		{
	case "HakemNAME":
		hakem.setName(cookie.getValue());
		break;
	case "HakemLASTNAME":
		hakem.setLastname(cookie.getValue());
		break;
	case "HakemEMAIL":
		hakem.setEmail(cookie.getValue());
		break;
	case "HakemID":
		hakem.setId(Integer.parseInt(cookie.getValue()));
		break;
		}
	}
}
if(hakem.getId() == -1) response.sendRedirect("HakemLogin");
%>
<body style="">
...
<div class="top-nav clearfix">
    ...
    <ul class="nav pull-right top-menu">
        <li>
        			<form action="<%=request.getContextPath()%>/Hakem_Logout" method="post">
        ...
        <div class="leftside-navigation" tabindex="5000" style="overflow: hidden; outline: none;">
            ...
            <li>
                    <a class="active">
                        ...
                        <span><%="Hoşgeldiniz "+hakem.getName()+" "+hakem.getLastname() %></span>
                    </a>
                </li>
                <li>
                    <a  href="<%=request.getContextPath()%>/HakemHome">
	...
	<section class="wrapper">
		...
		<div class="market-updates">
			<div class="col-md-3 market-update-gd">
				<div class="market-update-block clr-block-2">
					<div class="col-md-4 market-update-right">
	 				...
	 				<form action="<%=request.getContextPath()%>/Hakem_MakList" method="post">					
					 <h4>Tüm Makaleler</h4>
					<h3>   -------------------------</h3>
					<input type="text" value="t" name="ctrl" style="display:none;"/>
						<button type="submit" style=" background-color: transparent "><h3><p >Makale Sayfasına Gitmek İçin Tıklayınız.</p></h3></button>
						</form>
				  </div>
			...
			<div class="col-md-3 market-update-gd">
				...
				<form action="<%=request.getContextPath()%>/Hakem_MakList" method="post">	
				<h4>İşlenen Makaleler</h4>
						<h3>   -------------------------</h3>
						<input type="text" value="i" name="ctrl" style="display:none;"/>
						<button type="submit" style=" background-color: transparent "><h3><p>İşlemde Olan Makaleler İçin Tıklayınız.</p></h3></button>
						</form>
					</div>
				  <div class="clearfix"> </div>
				</div>
							...
							<div class="alert alert-success ">
								...
								<div class="notification-info">
									<ul class="clearfix notification-meta">
										...
										<li class="pull-right notification-time"><a  class="w3-right w3-circle w3-margin-right" style="width:35px" href="Hakem_MakView?id=<c:out value='${makale.ID}' />">Makaleye Göz At...</a>
</li>
									</ul>
									<p> 
						...
						<c:if test="${makale.aEditorDate == null}">
							<div class="alert alert-danger ">
								...
								<div class="notification-info">
									<ul class="clearfix notification-meta">
										<li class="pull-left notification-sender"><c:out value="${makale.makaleBilgi}" /></li>
										<li class="pull-right notification-time"><a   style="width:35px" href="Hakem_MakView?id=<c:out value='${makale.ID}' />">Makaleye Göz At...</a>
</li>
									</ul>
									<p>
										<c:out value="Yazar Adı Soyadı : ${makale.yazar.name} ${makale.yazar.lastname}" />
