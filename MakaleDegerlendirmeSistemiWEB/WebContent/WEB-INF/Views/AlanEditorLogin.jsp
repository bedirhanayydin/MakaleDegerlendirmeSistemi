<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<html lang="zxx"><head>
    <title>Alan Editörü Giriş Sayfası</title>
    <!-- Meta tag Keywords -->
    ...
    <!--//Style-CSS -->
<link rel="shortcut icon" type="images/png" href="images/icon2.png"/>
...
<body>
    ...
    <section class="w3l-hotair-form">
        <h1>Alan Editörü Giriş Sayfası</h1>
        <div class="container">
            <!-- /form -->
            <div class="workinghny-form-grid">
                <div class="main-hotair">
                    <div class="content-wthree">
                        <h2>Giriş Yap</h2>
                        <form action="<%=request.getContextPath()%>/AlanEditorLogin" method="post">
